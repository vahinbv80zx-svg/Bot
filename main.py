...
intents.guilds = True
intents.message_content = True # Required for sync and prefix
...
async def on_guild_join(guild: discord.Guild):
    ...
    try:
        ...
        if role and role not in me.roles:
...
async def help_cmd(interaction: discord.Interaction):
    ...
    embed.add_field(name="🏁  /flags", value="Get Roblox optimization flags for performance.", inline=False)
